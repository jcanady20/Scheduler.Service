...
{
  public static PagedList<JobHistory> JobHistorySearch(this ScheduleContext db, Models.JobHistorySearch model)
  {
  ...
  public static void AddJobHistory(this ScheduleContext db, int jobId, int stepId, string stepName, JobStepOutCome outcome, string message, Nullable<DateTime> runDateTime = null, Nullable<TimeSpan> duration = null)
  {
    ...
    public static async Task AddJobHistoryAsync(this ScheduleContext db, int jobId, int stepId, string stepName, JobStepOutCome outcome, string message, Nullable<DateTime> runDateTime = null, Nullable<TimeSpan> duration = null)
    {
        var jh = new JobHistory()
        {
            JobId = jobId,
