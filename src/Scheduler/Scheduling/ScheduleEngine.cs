...
public class ScheduleEngine
{
  ...
  public ScheduleEngine(ILogger logger, JobEngine jobEngine, ScheduleContext scheduleContext)
  {
  ...
  private void DoWork()
  {
    while(_canceled == false)
    {
      ...
      try
      {
          var schedules = GetActiveSchedules(_db);
          ProcessSchedules(schedules, _db);
      }
      catch(Exception e)
      {
