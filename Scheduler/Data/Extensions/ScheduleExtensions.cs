...
{
  private static readonly DateTime _maxDateTime = new DateTime(2099, 12, 31, 23, 59, 59);
  private static readonly DateTime _minDateTime = new DateTime(1980, 1, 1, 0, 0, 0);
  public static DateTime MaxDateTime(this Schedule schedule)
  {
    return _maxDateTime;
  }
  public static DateTime MinDateTime(this Schedule schedule)
  {
    return _minDateTime;
  }
  public static DateTime CalculateNextRun(this Schedule schedule, DateTime lastRunDateTime)
  {
  ...
  private static DateTime CalculateOnTimeOnly(this Schedule scheudle, DateTime lastRunDateTime)
  {
  ...
  private static DateTime CalculateMonthly(this Schedule schedule, DateTime lastRunDateTime)
  {
  ...
  private static DateTime CalculateSubDayInterval(this Schedule schedule, DateTime datetime)
  {
  ...
  public static string Description(this Schedule schedule)
  {
    var startDateTime = schedule.StartDate + schedule.StartTime;
  ...
  private static StringBuilder GetSubIntervalDescription(this Schedule schedule)
  {
    var msg = new StringBuilder();
    var startDateTime = schedule.StartDate + schedule.StartTime;
    var endDatetime = schedule.EndDate + schedule.EndTime;
  ...
  private static StringBuilder GetWeeklyDescription(this Schedule schedule)
  {
    var msg = new StringBuilder();
  ...
  private static StringBuilder GetMonthlyDescription(this Schedule schedule)
  {
    var msg = new StringBuilder();
  ...
  private static StringBuilder GetMonthlyRelativeDescription(this Schedule schedule)
  {
    var msg = new StringBuilder();
